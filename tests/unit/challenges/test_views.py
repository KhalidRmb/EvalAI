...
class BaseAPITestClass(APITestCase):
    ...
    def test_download_and_extract_file(self):
        download_location = os.path.join(BASE_TEMP_DIR, "test_file.txt")
    ...
    def test_download_and_extract_zip_file(self):
        download_location = os.path.join(BASE_TEMP_DIR, "zip_download_location.zip")
        extract_location = os.path.join(BASE_TEMP_DIR, "zip_extract_location")

        download_and_extract_zip_file(self.url, download_location, extract_location)
        self.assertTrue(os.path.isfile(download_location))
        self.assertTrue(os.path.isfile(os.path.join(extract_location, "dummy_input.txt")))
        os.remove(download_location)
        shutil.rmtree(extract_location)

    def test_create_dir(self):
        directory = os.path.join(BASE_TEMP_DIR, "temp_dir")
    ...
    def test_create_dir_as_python_package(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(directory, "__init__.py")))
        shutil.rmtree(directory)
